                ...
                <form onSubmit={(e)=>{
                    ...
                    <div className="popupSection">
                        <div className="inputContainer">
                            ...
                            <input type="number" id="customAmount" value={customAmount} onChange={(e)=>setCustomAmount(parseInt(e.target.value))} required />
                        </div>
                        <div className="popupButtonContainer">
                            ...
                            >Cancel</button>
                        <button type="submit" className="coloredBtn">Add</button>
                        </div>
                    </div>
                </form>
            </div>
